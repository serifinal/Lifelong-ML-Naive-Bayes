...
public class CombineData_Test {
    ...
    public static void main(String[] args) throws IOException {
        CombineData_Test combineData = new CombineData_Test();
        combineData.buildModel(0,1);
        System.out.println(combineData.sumNeg);
        System.out.println(combineData.sumNeg);
        ...
        while (true) {
            ...
            combineData.tokenizer(inputFile, outFile);
            ...
            for (String s : testDoc.getListWord().getListKeys()) {
                System.out.println(s + " : " + combineData.xPos.get(s) + " - " + combineData.xNeg.get(s));
            }
            int predict = combineData.predictLabel(testDoc);
            if (predict == 1) {
